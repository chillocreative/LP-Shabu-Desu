    ...
    <nav className={`fixed w-full z-40 transition-all duration-500 ${
      ...
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <a href="#" className="flex flex-col items-center group">
          <span className="font-serif text-2xl tracking-widest text-gold-400 group-hover:text-white transition-colors">SHABU DESU</span>
          <span className="text-[10px] uppercase tracking-[0.3em] text-stone-400 group-hover:text-gold-400 transition-colors">Premium Hotpot</span>
        </a>
